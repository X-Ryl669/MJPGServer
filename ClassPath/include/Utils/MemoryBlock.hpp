    ...
    */
    ...
    public:
        ...
        /** Get the allocated size.
            This is used to ensure you are not overflowing the allocated buffer when dealing with raw pointers.
            Typically used with ensureSize to resize the buffer without changing content */

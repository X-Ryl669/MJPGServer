    ...
    namespace PrivateGenericImplementation
    {
        ...
        */
        ...
        public:
            ...
            /** Default element construction with a reservation for given size */
            explicit Array(const size_t count) : array(0), currentSize(0), allocatedSize(0) { Reserve(count); }
        ...
        public:
            ...
            /** Pregrow the array with the given number of elements. It's emptied then grown to the given size */
            inline void Pregrow(const size_t count) { Clear(); Reserve(count); }
        ...
        private:
            /** Reserve some size in the array (not necessarly used) */
            inline void Reserve(const size_t count) throw()
            {
                array = Policy::NonDestructiveAlloc(array, 0, count, (T*)0);
                if (array) allocatedSize = count;
            }
        ...
        */
        ...
        public:
            ...
            inline void Clear() { Clear(0); }
            /** Pregrow the array with the given number of elements. It's emptied then grown to the given size */
            inline void Pregrow(const size_t count) { Clear(); Grow(count, 0); currentSize = 0; }
